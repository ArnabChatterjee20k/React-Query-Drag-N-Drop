...
const TodoList = () => {
  ...
  useEffect(() => {
    ...
    // checking if the array of ids is present in the local storage
    ...
    updateTodos(myArray || data); // if myArray is undefined then store data
  }, [data]);
  ...
  const handleOnDragEnd = (result) => {
    ...
    // storing the ids array in the localstorage so that it persists after reload
